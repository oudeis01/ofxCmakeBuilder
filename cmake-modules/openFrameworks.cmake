...
if(CMAKE_SYSTEM_NAME STREQUAL "Linux")
    ...
    elseif(CMAKE_SYSTEM_PROCESSOR MATCHES "aarch64")
        set(OF_PLATFORM "linuxaarch64")
    elseif(CMAKE_SYSTEM_PROCESSOR MATCHES "armv7l")
        set(OF_PLATFORM "linuxarmv7l")
    elseif(CMAKE_SYSTEM_PROCESSOR MATCHES "armv6l")
        set(OF_PLATFORM "linuxarmv6l")
    else()
    ...
    if(EXISTS ${addon_path})
        ...
        if(EXISTS "${addon_path}/libs")
            ...
            if(UNIX AND NOT APPLE)  # Linux
                ...
                # Handle multi-arch linux filtering
                if(OF_PLATFORM STREQUAL "linux64")
                    list(FILTER ADDON_LIB_CPP_SOURCES EXCLUDE REGEX ".*/linuxaarch64/.*")
                    list(FILTER ADDON_LIB_CPP_SOURCES EXCLUDE REGEX ".*/linuxarmv7l/.*")
                    list(FILTER ADDON_LIB_CPP_SOURCES EXCLUDE REGEX ".*/linuxarmv6l/.*")
                elseif(OF_PLATFORM STREQUAL "linuxaarch64")
                    list(FILTER ADDON_LIB_CPP_SOURCES EXCLUDE REGEX ".*/linux64/.*")
                    list(FILTER ADDON_LIB_CPP_SOURCES EXCLUDE REGEX ".*/linuxarmv7l/.*")
                    list(FILTER ADDON_LIB_CPP_SOURCES EXCLUDE REGEX ".*/linuxarmv6l/.*")
                endif()
                ...
                # Handle multi-arch linux filtering for C files
                if(OF_PLATFORM STREQUAL "linux64")
                    list(FILTER ADDON_LIB_C_SOURCES EXCLUDE REGEX ".*/linuxaarch64/.*")
                    list(FILTER ADDON_LIB_C_SOURCES EXCLUDE REGEX ".*/linuxarmv7l/.*")
                    list(FILTER ADDON_LIB_C_SOURCES EXCLUDE REGEX ".*/linuxarmv6l/.*")
                elseif(OF_PLATFORM STREQUAL "linuxaarch64")
                    list(FILTER ADDON_LIB_C_SOURCES EXCLUDE REGEX ".*/linux64/.*")
                    list(FILTER ADDON_LIB_C_SOURCES EXCLUDE REGEX ".*/linuxarmv7l/.*")
                    list(FILTER ADDON_LIB_C_SOURCES EXCLUDE REGEX ".*/linuxarmv6l/.*")
                endif()
            ...
            if(EXISTS "${addon_path}/libs")
                ...
                elseif(UNIX)
                    set(addon_lib_path "${addon_path}/libs/*/lib/${OF_PLATFORM}")
                    # Fallback for generic linux libs (often 32-bit x86 or universal)
                    if(NOT EXISTS "${addon_lib_path}" AND OF_PLATFORM MATCHES "linux")
                         if(EXISTS "${addon_path}/libs/*/lib/linux")
